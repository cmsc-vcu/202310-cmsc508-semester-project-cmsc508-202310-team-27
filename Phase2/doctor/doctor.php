...
$d_email = $_POST['email'];  
if(empty($d_email) || empty ($password))
{
...
$d_query="select* from doctor where  email='$d_email'  AND pswd='$password' AND permission='Approved' OR  email='$d_email'    AND pswd='$password' AND permission='Added'";
