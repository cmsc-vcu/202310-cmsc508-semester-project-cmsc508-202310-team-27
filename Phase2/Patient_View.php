...
<title>Patient View Table</title>
</head>
<style>
h1{
font-size:50px;
...
<h1 class="text-monocase text-capitalize text-center text-light">Patient View Table</h1>
				   ...
				   while($row = mysqli_fetch_array($run))
				   {
                    echo "<h3><tr><th>". $row['ID'] ." </h3>";
                      echo "<h3><th>". $row['Name'] ." </h3>";
                        echo "<h3><th>". $row['Gender'] ." </th></tr></h3>";
				   }
			   ?></table></ul>
