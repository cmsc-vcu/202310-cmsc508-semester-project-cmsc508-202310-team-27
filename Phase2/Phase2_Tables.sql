...
INSERT INTO Medical_Check_up(Medical_Check_up_ID, Medical_Check_up_date, Medical_Check_up_time, Medical_Check_up_reason, Medical_Check_up_documentation) VALUES
  (110,"3/23/19","12:00 PM","High temperature","The patient has high temperature"),
  (111,"2/27/15","4:45 PM","Headaches","The patient has a headache and hasn't been able to sleep well due to this, therefore, more test will be done"),
  (112,"10/23/18","8:30 AM","High temperature","The patient has high temperature"),
  (113,"6/22/15","6:20 AM","Bladder changes","The patient needs further test"),
  (114,"4/13/20","6:55 PM","Cough","The patient is not feeling good, has a really bad cough"),
  (115,"5/16/20","5:50 PM","Eating problems","Patient has not appetite"),
  (116,"12/22/22","11:30 AM","Severe fatigue","The patient has fainted due to fatigue"),
  (117,"6/20/21","7:23 AM","Trouble urinating","The patient hasn't been able to urinate properly and occasional bladder pain is involved"),
  (118,"11/15/22","10:30 AM","Nausea","The patient has been feeling nauseous for the past week"),
  (119,"1/27/18","8:50 AM","Nose bleeding","The patient is suffering form severe dehydration"),
  (120,"","","",""),
  (121,"","","",""),
  (122,"","","",""),
  (123,"","","",""),
